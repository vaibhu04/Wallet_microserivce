package com.vaibhav.walletservice.Controller;

import com.vaibhav.walletservice.Model.*;
import com.vaibhav.walletservice.Repository.TransactionRepository;
import com.vaibhav.walletservice.Repository.WalletRepository;
import com.vaibhav.walletservice.Util.TransactionValidator;
import com.vaibhav.walletservice.Util.WalletValidator;
import com.vaibhav.walletservice.exception.TransactionBadRequest;
import com.vaibhav.walletservice.service.EmailService;
import com.vaibhav.walletservice.service.UserService;
import com.vaibhav.walletservice.Model.AddBalanceDetails;
import com.vaibhav.walletservice.Model.Transaction;
import com.vaibhav.walletservice.Model.User;
import com.vaibhav.walletservice.Model.Wallet;
...
public class TransactionResource {
    ...
    private void sendTxnHistory(String id) {
        ...
        try {
            ...
            EmailService.sendEmailWithAttachments("Vaibhav Agrawal Sent You Transaction Details","",user1.getEmail(),"",user1.getEmail(),"Wallet Transactions!!","Thank You!! for transacting with us..",filename);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
