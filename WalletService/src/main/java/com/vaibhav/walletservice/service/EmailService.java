package com.vaibhav.walletservice.service;
import com.vaibhav.walletservice.Util.EmailUtil;
...
public class EmailService {
    ...
    public static  final String FROM_EMAIL = "1204vaibhav@gmail.com"; //requires valid gmail id
    public static final String PASSWORD = "1204@Idea"; // correct password for gmail id
